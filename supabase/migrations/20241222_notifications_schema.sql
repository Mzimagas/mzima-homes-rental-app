...
CREATE INDEX idx_notification_rules_landlord_id ON notification_rules(landlord_id);
...
CREATE INDEX idx_notification_templates_landlord_id ON notification_templates(landlord_id);
CREATE INDEX idx_notification_templates_type ON notification_templates(type);
CREATE INDEX idx_notification_templates_channel ON notification_templates(channel);

CREATE INDEX idx_notification_history_landlord_id ON notification_history(landlord_id);
