...
async function fetchUnit(id: string) {
  const res = await fetch(`${process.env.NEXT_PUBLIC_APP_URL || ''}/api/public/units/${id}`, {
    cache: 'no-store',
  })
      ...
      <div className="container py-8">
        ...
        <div className="mb-8">
          <div className="flex items-start justify-between mb-4">
            <div>
              <h1 className="text-3xl font-bold text-primary mb-2">{unit.unit_label}</h1>
              ...
              {unit.physical_address && (
                <p className="text-tertiary flex items-center mt-1">
                  <svg
                    className="w-4 h-4 mr-1 text-quaternary"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
            ...
            <div className="flex items-center space-x-3">
              ...
              <span
                className={`inline-flex px-3 py-1 text-sm font-medium rounded-full ${status.color}`}
              >
                {status.text}
              </span>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <ImageGallery
              media={media || []}
              unitName={`${unit.property_name} - ${unit.unit_label}`}
            />
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`px-3 py-1.5 text-xs font-medium rounded-full ${status.color}`}
                      >
                        {status.text}
                      </span>
                    </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-elevated rounded-xl shadow-md border border-light p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center space-x-3">
                  <svg
                    className="w-5 h-5 text-quaternary"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
