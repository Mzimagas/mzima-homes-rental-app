...
export const metadata: Metadata = {
  ...
  description:
    'Browse available rental units and find your perfect home with Mzima Homes. View photos, amenities, and submit reservation requests.',
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-secondary text-sm leading-relaxed">
                Professional property management and rental services. Find your perfect home with
                us.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <a href="/rent" className="text-secondary hover:text-brand transition-colors">
                    Browse Units
                  </a>
                </li>
                <li>
                  <a
                    href="/rent?amenities=PARKING"
            ...
            <div>
              ...
              <div className="text-sm text-secondary space-y-2">
                <p className="flex items-center">
                  <svg
                    className="w-4 h-4 mr-2 text-tertiary"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
