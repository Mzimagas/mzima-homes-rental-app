...
export function AmenityIcon({ code, className = "w-5 h-5" }: AmenityIconProps) {
  const iconMap: Record<string, JSX.Element> = {
    ...
    BALCONY: (
      <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 21h18M5 21V7l8-4v18M9 9h1m0 0h1m-1 0v1m0-1V8M9 21v-4a2 2 0 012-2h2a2 2 0 012 2v4" />
      </svg>
    ),
    WIFI: (
      <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return iconMap[code.toUpperCase()] || (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
