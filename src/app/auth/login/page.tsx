    ...
    try {
      ...
      if (error) {
        ...
        fetch('/api/security/lockout', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({ action: 'login', identifier: email, success: false }),
        })
        fetch('/api/security/audit', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({ event: 'login_failed', identifier: email }),
        })
        ...
        fetch('/api/security/lockout', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({ action: 'login', identifier: email, success: true }),
        })
        if (error === 'MFA_REQUIRED') {
