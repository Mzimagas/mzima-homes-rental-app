...
import { useTabState, TabNavigation, TabContent, HANDOVER_TABS, useTabNavigation } from '../../../components/properties/utils/tab-utils'
...
export default function ClientPropertyCard({ property }: ClientPropertyCardProps) {
  ...
  return (
    <div ref={cardRef} className="bg-gradient-to-r from-white via-blue-50/50 to-blue-100/30 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden border-2 border-blue-200 hover:border-blue-300">
        ...
        <div className="flex-1 p-6">
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-6">
            ...
            <div className="flex-1 mb-4 lg:mb-0">
              <h3 className="text-xl font-semibold text-gray-900 mb-2 line-clamp-2">{property.name}</h3>
              ...
              {property.status === 'IN_HANDOVER' && (
                <div className="mb-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-sm font-semibold text-blue-700">{property.handover_progress}%</span>
                  </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-start space-x-3 p-3 bg-green-50 rounded-lg border border-green-200">
                            ...
                            <div>
                              <span className="text-sm font-medium text-green-600">Asking Price</span>
                              <p className="text-green-900 font-bold text-lg">{formatCurrency(property.asking_price_kes)}</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center justify-center p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                            ...
                            >
                              {property.handover_status?.replace('_', ' ') || getStatusLabel(property.status)}
                            </span>
                          </div>
                            ...
                            <>
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="mt-2">
                                    <div className="flex items-center justify-between mb-1">
                                      <span className="text-blue-900 font-bold">{property.handover_progress}%</span>
                                    </div>
                              ...
                              <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                                ...
                                <div>
                                  ...
                                  <p className="text-gray-900 font-medium">{property.current_stage}</p>
                                </div>
                              </div>
                            </>
                          )}
                          ...
                          <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                            <div className="text-gray-400 mt-0.5">📅</div>
                            <div>
                              <span className="text-sm font-medium text-gray-500">Interest Date</span>
