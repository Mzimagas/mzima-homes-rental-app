"use client"
import { type PropertyType, getPropertyTypeLabel, getPropertyTypeIcon, getPropertyTypeColor } from '../../lib/validation/property'
...
export function PropertyTypeBadgeCompact({ type, className = '' }: { type: PropertyType; className?: string }) {
  return (
    <PropertyTypeBadge 
      type={type} 
      size="sm" 
...
export function PropertyTypeBadgeLarge({ type, className = '' }: { type: PropertyType; className?: string }) {
  return (
    <PropertyTypeBadge 
      type={type} 
      size="lg" 
