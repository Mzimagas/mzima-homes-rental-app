            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mt-4">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <h4 className="text-sm font-medium text-blue-800">Financial Data Integration</h4>
                    <p className="text-sm text-blue-700 mt-1">
                      Financial APIs are currently being developed. This section will display detailed acquisition costs and payment installments once the backend services are implemented.
                    </p>
                  </div>
                </div>
              </div>
