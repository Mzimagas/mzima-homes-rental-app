...
export default function MaintenanceStats({ stats }: MaintenanceStatsProps) {
  ...
  const getCostVariance = () => {
    ...
    const variance = ((stats.totalActualCost - stats.totalEstimatedCost) / stats.totalEstimatedCost) * 100
          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-lg font-medium text-gray-900">{formatCurrency(stats.totalActualCost)}</dd>
              </dl>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-lg font-medium text-gray-900">{stats.averageResolutionTime} days</dd>
              </dl>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              <div className={`text-2xl font-bold ${
                ...
                {parseFloat(getCostVariance()) > 0 ? '+' : ''}{getCostVariance()}%
              </div>
          ...
          {stats.totalEstimatedCost > 0 && (
            <div className="mt-4">
              <div className="flex justify-between text-sm text-gray-600 mb-1">
                ...
                <span>{((stats.totalActualCost / stats.totalEstimatedCost) * 100).toFixed(1)}% of budget used</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div 
                  className={`h-2 rounded-full ${
                    stats.totalActualCost <= stats.totalEstimatedCost ? 'bg-green-500' : 'bg-red-500'
                  }`}
                  style={{ 
