...
export default function MaintenanceList({ tickets, onTicketSelect, onTicketUpdate }: MaintenanceListProps) {
                      ...
                      <div className="space-y-1 text-gray-600">
                        ...
                        {ticket.est_cost_kes && ticket.actual_cost_kes && (
                          <div className={`font-medium ${
                            ticket.actual_cost_kes <= ticket.est_cost_kes ? 'text-green-600' : 'text-red-600'
                          }`}>
