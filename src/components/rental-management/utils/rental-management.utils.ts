import { RentalProperty, RentalTenant, LeaseAgreement, MaintenanceRequest } from '../types/rental-management.types'
...
export const getLeaseStatus = (lease: LeaseAgreement): {
  label: string
  color: string
...
export const getTenantStatus = (tenant: RentalTenant): {
  label: string
  color: string
...
// Sorting utilities
export const sortPropertiesByOccupancy = (properties: RentalProperty[], ascending: boolean = false): RentalProperty[] => {
...
export const sortTenantsByName = (tenants: RentalTenant[], ascending: boolean = true): RentalTenant[] => {
...
export const sortMaintenanceByPriority = (requests: MaintenanceRequest[], ascending: boolean = false): MaintenanceRequest[] => {
...
// Filter utilities
export const filterPropertiesByType = (properties: RentalProperty[], type: string): RentalProperty[] => {
...
export const filterMaintenanceByStatus = (requests: MaintenanceRequest[], status: string): MaintenanceRequest[] => {
  if (status === 'all') return requests
  return requests.filter(request => request.status === status)
}

// Search utilities
export const searchProperties = (properties: RentalProperty[], searchTerm: string): RentalProperty[] => {
...
export const searchMaintenanceRequests = (requests: MaintenanceRequest[], searchTerm: string): MaintenanceRequest[] => {
