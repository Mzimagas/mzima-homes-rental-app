...
export default function EnhancedPaymentForm({ 
  ...
  const processingFee = methodInfo ? PaymentService.calculateProcessingFee(watchedValues.method, watchedValues.amount || 0) : 0
  ...
  const getFieldsForStep = (step: number): (keyof PaymentFormValues)[] => {
    switch (step) {
      ...
      case 1: return ['amount', 'paymentDate']
      case 2: return ['method']
      case 3: return ['txRef', 'notes']
      default: return []
    }
  }
                ...
                <div>
                  ...
                  {methodInfo && (
                    <div className="mt-3 p-4 bg-blue-50 rounded-md">
                      ...
                      <p className="text-xs text-blue-600 mt-1">Processing time: {methodInfo.processingTime}</p>
                      {processingFee > 0 && (
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span>Amount:</span>
                      <span className="font-medium">{(watchedValues.amount || 0).toLocaleString()} KES</span>
                    </div>
                    {processingFee > 0 && (
                      <div className="flex justify-between">
