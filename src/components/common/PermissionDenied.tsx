            ...
            <div className="flex">
              ...
              <div className="text-sm text-red-700">
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>Only property <strong>OWNERS</strong> can manage users</li>
...
export function UserManagementDenied({ currentRole, className }: { currentRole?: string; className?: string }) {
  return (
    <PermissionDenied
...
export function PropertyEditDenied({ currentRole, className }: { currentRole?: string; className?: string }) {
  return (
    <PermissionDenied
