  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          return (
            <div
              ...
              className={`relative p-4 rounded-lg border-2 cursor-pointer transition-all duration-200 transform hover:scale-105 ${
                getStageCardStyling(isActive, isCompleted, canAccess)
              }`}
            ...
            >
              ...
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold mb-2 ${
                getStageStatusColor(stageInfo!, isActive, isCompleted)
              }`}>
      ...
      <div className="flex justify-between items-center mt-4 pt-4 border-t border-gray-200">
        ...
        <div className="flex items-center space-x-2">
          <span className="text-xs text-gray-500">Stage {currentStage} of {PIPELINE_STAGES.length}</span>
        </div>
      </div>
    </div>
  )
