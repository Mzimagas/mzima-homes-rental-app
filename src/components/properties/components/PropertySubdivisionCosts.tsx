...
export default function PropertySubdivisionCosts({
  ...
  // Note: Prefill handling for subdivision_costs subtab is now handled by PropertyAcquisitionFinancials
  // to provide a unified cost entry interface through the acquisition costs dropdown
