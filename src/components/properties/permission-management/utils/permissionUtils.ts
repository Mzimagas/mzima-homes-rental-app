...
export const getAvailableScopeOptions = (filterRoleTemplate: RoleTemplate | 'all'): PermissionOption[] => {
  const baseOptions = [
...
export const getAvailableLevelOptions = (filterRoleTemplate: RoleTemplate | 'all'): PermissionOption[] => {
  const baseOptions = [
