...
export const usePropertySelection = () => {
  ...
  const searchPropertiesDebounced = useCallback(async (searchTerm: string) => {
    if (!searchTerm.trim()) {
