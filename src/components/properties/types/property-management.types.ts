...
export const SUBDIVISION_COST_TYPES: SubdivisionCostType[] = [
  ...
  {
    id: 'subdivision_lcb_special_fee',
    category: 'SURVEY_PLANNING_FEES',
  ...
  {
    id: 'subdivision_mutation_drawing',
    category: 'SURVEY_PLANNING_FEES',
  ...
  {
    id: 'subdivision_new_parcel_numbers',
    category: 'SURVEY_PLANNING_FEES',
  ...
  {
    id: 'subdivision_new_title_registration',
    category: 'SURVEY_PLANNING_FEES',
