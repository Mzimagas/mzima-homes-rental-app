      ...
      {accounts.map(ac => (
        <div key={ac.id} className="border rounded p-4">
          <div className="flex items-center justify-between">
            ...
            {ac.type === 'ELECTRICITY_PREPAID' && ac.low_balance_threshold_kes != null && ac.balance_kes <= ac.low_balance_threshold_kes && (
              <span className="text-yellow-700 bg-yellow-100 px-2 py-1 rounded text-xs">Low balance</span>
            )}
