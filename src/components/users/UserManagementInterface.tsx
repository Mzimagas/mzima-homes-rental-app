  ...
  if (showAddUser) {
    return (
      <div className={className}>
        <div className="mb-6">
          <Button variant="outline" onClick={() => setShowAddUser(false)} className="mb-4">
            ← Back to User List
          </Button>
        </div>
  ...
  return (
    <div className={className}>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        ...
        <Button onClick={() => setShowAddUser(true)} className="mt-4 sm:mt-0">
          Add New User
        </Button>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-12 text-center">
          <div className="max-w-md mx-auto">
            ...
            <Button onClick={() => setShowAddUser(true)}>Add First User</Button>
          </div>
        </div>
      ) : (
        <>
