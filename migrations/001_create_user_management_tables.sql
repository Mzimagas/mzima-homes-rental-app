...
CREATE INDEX idx_enhanced_users_member_number ON enhanced_users(member_number);
...
CREATE INDEX idx_user_permissions_property_id ON user_permissions(property_id);
CREATE INDEX idx_user_permissions_role_template ON user_permissions(role_template);
...
CREATE INDEX idx_permission_audit_performed_at ON permission_audit_log(performed_at);
CREATE INDEX idx_permission_audit_action ON permission_audit_log(action);

CREATE INDEX idx_user_next_of_kin_user_id ON user_next_of_kin(user_id);
CREATE INDEX idx_user_next_of_kin_priority ON user_next_of_kin(priority_order);
