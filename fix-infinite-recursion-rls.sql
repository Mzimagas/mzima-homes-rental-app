...
-- This resolves the "infinite recursion detected in policy for relation 'properties'" error
...
-- ============================================================================
-- STEP 3: Update helper functions to avoid recursion
-- ============================================================================
...
DROP FUNCTION IF EXISTS public.get_user_accessible_properties();
DROP FUNCTION IF EXISTS public.get_user_accessible_properties(UUID);
DROP FUNCTION IF EXISTS public.get_user_accessible_properties(user_uuid UUID);
...
-- ============================================================================
-- STEP 4: Create a bypass function for service role operations
-- ============================================================================

-- Function to get properties without RLS for service role
CREATE OR REPLACE FUNCTION get_properties_for_user(target_user_id UUID)
RETURNS TABLE(
  property_id UUID,
  property_name TEXT,
...
GRANT EXECUTE ON FUNCTION get_properties_for_user TO service_role;
GRANT EXECUTE ON FUNCTION get_properties_for_user TO authenticated;
